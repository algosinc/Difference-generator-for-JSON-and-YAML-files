...
# PATH_TO_JSON_1_FILE = r'G:\My Drive\_Dev\python-project-lvl2\tests\fixtures\json\file1.json'
# PATH_TO_JSON_2_FILE = r'G:\My Drive\_Dev\python-project-lvl2\tests\fixtures\json\file2.json'
# PATH_TO_JSON_RESULT_FILE = r'G:\My Drive\_Dev\python-project-lvl2\tests\fixtures\json\json_result.txt'
